...
```
    ...
    ##       /tmp/RtmptG3kQx/file1f83ba3aad6.bam 
    ## "/tmp/RtmptG3kQx/file1f83ba3aad6.bam.bai"
...
```
    ...
    ##  [49] compiler_4.6.0           bit64_4.8.2              doParallel_1.0.17       
    ...
    ##  [94] xfun_0.58                stringi_1.8.7            UCSC.utils_1.8.0        
